  ...
  return (
    <div className="w-full flex flex-col items-center px-4 md:px-6 my-6 pb-12">
      <div className="w-full max-w-4xl">
        <h1 className="text-2xl font-bold text-gray-800 mb-2">Mis Viajes</h1>
        <p className="text-gray-700 mb-6">Publica trayectos para ofrecer plazas a tus clientes y optimizar tus recorridos.</p>
            ...
            <div className="p-6 md:p-8 grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
              <div className="md:col-span-2">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h2 className="text-xl font-semibold text-gray-800">Publica tu primer viaje</h2>
                </div>
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 mt-5 px-4 py-2 rounded-lg bg-amber-700 hover:bg-amber-800 text-white font-medium shadow-sm transition cursor-pointer"
                >
                  <PlusCircle className="h-5 w-5" /> Publicar mi primer viaje
                </button>
              </div>
              <div className="hidden md:block">
                <div className="rounded-xl border border-gray-200 bg-gradient-to-br from-amber-50 to-white p-6 h-full flex items-center justify-center">
                  <Route className="h-16 w-16 text-amber-600" />
                </div>
              </div>
            </div>
          </div>
