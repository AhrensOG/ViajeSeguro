...
export default function VehiclesPanel() {
    ...
    return (
        <div className="w-full h-full flex flex-col overflow-hidden pb-2">
                    ...
                    <table className="min-w-full text-sm text-left table-fixed border-separate border-spacing-0">
                        <thead className="bg-custom-golden-100 text-custom-golden-700 uppercase text-xs">
                            <tr>
                                ...
                                <th className="px-4 py-2 border-b border-r border-custom-gray-300">Tipo de servicio</th>
                                <th className="px-4 py-2 border-b border-r border-custom-gray-300">Proveedor</th>
                                <th className="px-4 py-2 border-b border-r border-custom-gray-300">Selección de asientos</th>
                        ...
                        <tbody className="text-custom-black-800">
                            {filteredVehicles.map((vehicle, index) => (
                                ...
                                >
                                    <td className="px-4 py-2 border-b border-r border-custom-gray-200 font-medium">{vehicle.plate}</td>
                                    <td className="px-4 py-2 border-b border-r border-custom-gray-200">{vehicle.capacity}</td>
                                    <td className="px-4 py-2 border-b border-r border-custom-gray-200">{String(vehicle.serviceType)}</td>
                                    <td className="px-4 py-2 border-b border-r border-custom-gray-200">{String(vehicle.provider)}</td>
            ...
            {isCreateModalOpen && <CreateVehicleModal onClose={() => setIsCreateModalOpen(false)} owners={owners} onSuccess={handleAddVehicle} />}
