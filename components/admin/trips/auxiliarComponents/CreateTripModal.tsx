...
const CreateTripModal = ({ onClose, onSuccess, partners, drivers }: Props) => {
    const [form, setForm] = useState<CreateTripRequest>({
        ...
        departure: "",
        arrival: "",
        originalTimeZone: "Europe/Lisbon",
            ...
            <div className="bg-white rounded-xl shadow-2xl p-8 my-8 w-full max-w-4xl max-h-[95vh] overflow-y-auto relative border border-custom-gray-300">
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-5 text-sm text-custom-black-800">
                    ...
                    <div className="col-span-full">
                        ...
                        <select name="vehicleId" value={form.vehicleId} onChange={handleChange} className={inputClass} required>
                    ...
                    <div className="col-span-full flex justify-end gap-3 mt-8">
                        ...
                        <button
                            ...
                            disabled={!form.vehicleId || !form.partnerId || !form.driverId}
                        >
                            Crear viaje
                        </button>
                    </div>
