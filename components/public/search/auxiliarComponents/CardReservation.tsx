  ...
  return (
    <article
      ...
      <div className="flex flex-col gap-3 grow-1 justify-evenly">
        ...
        <div className="flex gap-2">
          ...
          <p className="flex gap-2 items-center text-sm">
            ...
            {transmissionTypeMap[transmissionType as TransmissionKey] ??
              transmissionType}
          </p>
        </div>
        <div className="flex flex-wrap gap-1">
          {features.map((featureKey, idx) => (
            <p
              key={idx}
              className="text-sm bg-custom-gray-300 rounded-full p-2">
      ...
      <div className="flex flex-col gap-2 w-[18rem] items-end justify-evenly">
        ...
        <p className="text-custom-gray-700 text-3xl font-bold">
          {"€ " + pricePerDay}
        </p>
        <p className="text-custom-black-700 text-lg">{`${pricePerDay}€/dia x ${calculateTotalDays(
          dateStart,
          dateEnd
        )} dias`}</p>
        <Link
          ...
          className="py-3 px-6 bg-custom-golden-600 text-custom-white-100 rounded-md flex gap-2 items-center justify-center cursor-pointer hover:bg-custom-golden-700">
          Reservar
