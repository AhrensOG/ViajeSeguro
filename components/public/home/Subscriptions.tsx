        ...
        >
            <div className="max-w-7xl mx-auto">
                ...
                <p className="text-center text-custom-gray-600 max-w-2xl mx-auto mb-8">
                    Únete a uno de nuestros planes y obtén descuentos exclusivos en tus viajes compartidos entre Madrid, Barcelona y Valencia. Sin
                    cuotas ocultas, sin sorpresas.
                </p>
                                ...
                                <div className="mt-4">
                                    <div className="flex flex-col items-baseline gap-2">
                                        <div className="flex items-baseline gap-2">
                                            ...
                                            {plan.suffix && <span className="text-custom-gray-600">{plan.suffix}</span>}
                                        </div>
                                        <div className="flex items-baseline gap-2">
                                            {plan.originalPrice && (
                                                <div className="flex items-baseline gap-2">
                                                    <span className="text-lg line-through text-custom-gray-500">{plan.originalPrice}</span>
                                                    <span className="text-custom-gray-600">{plan.suffix}</span>
                                                </div>
                                            )}
                                        </div>
                                    </div>
                                    <div
                                        className={`${
                                            plan.extraNote ? "text-custom-golden-700 animate-pulse-beat" : "text-transparent "
